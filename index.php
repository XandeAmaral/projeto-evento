...
if (filter_input(INPUT_POST, 'btnCadastroIntegrante')){
  ...
  header("Location: http://localhost/teste/?p=$tela&msg=$msg");
  exit();
}
if (filter_input(INPUT_POST, 'btnBuscarId')) {
  $id = filter_input(INPUT_POST, 'txtId');
  header("Location: http://localhost/teste/?p=$tela&id=$id");
  exit();
}
if(filter_input(INPUT_POST,'btnBuscarCPF')){
  $cpf = filter_input(INPUT_POST, 'txtCpf');
  header("Location: http://localhost/teste/?p=$tela&cpf=$cpf");
  exit();
}